...
namespace RenameConnectionStrings
{
    class RenameConnectionStrings
    {
        static void Main(string[] args)
        {
            ...
            string stringsPathLosApplicationWebApi = Constants.PATH_TO_LOS_FOLDER + @"\LOS\src\Los.Application\Web\Los.Application.Web\appsettings.Development.json";
            ...
            string stringsPathLosApplicationXComRunner = Constants.PATH_TO_LOS_FOLDER + @"\LOS\src\Los.Application\Infrastructure\Los.Application.XCom.Runner\ConnectionStrings.Dev.config";
            ...
            string stringsPathLosClientPortalWebApi = Constants.PATH_TO_LOS_FOLDER + @"\LOS\src\Los.ClientPortal\Web\Los.ClientPortal.Web\appsettings.Development.json";
            ...
            string stringsPathLosClientPortalXComRunner = Constants.PATH_TO_LOS_FOLDER + @"\LOS\src\Los.ClientPortal\Infrastructure\Los.ClientPortal.XCom.Runner\ConnectionStrings.Dev.config";
            ...
            string stringsPathLosFeesXComRunner = Constants.PATH_TO_LOS_FOLDER + @"\LOS\src\Microservices\Los.LoanFees\Infrastructure\Los.LoanFees.XCom.Runner\ConnectionStrings.Dev.config";
            ...
            string stringsPathLoanRatesXComRunner = Constants.PATH_TO_LOS_FOLDER + @"\LOS\src\Microservices\Los.LoanRates\Infrastructure\Los.LoanRates.XCom.Runner\ConnectionStrings.Dev.config";
